...
export const rooms: { [roomId: string]: Room } = {
    ...
    admin_st: {
        ...
        backgroundColor: "#c0c0c0",
        objects: [
            { x: 1, y: 5, url: "house1.svg", scale: 1, offset: { x: 241, y: -28 } },
            { x: 1, y: 5, url: "house2.svg", scale: 1, offset: { x: 241, y: 2 } },
            { x: 5, y: 4, url: "trash-bin1.svg", scale: 1, offset: { x: 365, y: 169 } },
            { x: 6, y: 4, url: "trash-bin2.svg", scale: 1, offset: { x: 375, y: 152 } },
            { x: 5, y: 7, url: "go-table.svg", scale: 1, offset: { x: 492, y: 140 } },
            { x: 5, y: 6, url: "chair.svg", scale: 1, offset: { x: 469, y: 174 } },
            { x: 5, y: 8, url: "chair.svg", scale: 1, offset: { x: 549, y: 134 } },

            { x: 6, y: 5, url: "boom-barrier.svg", scale: 1, offset: { x: 440, y: 187 } },
            { x: 10, y: 4, url: "funkyboon.svg", scale: 1, offset: { x: 527, y: 217 } },
        ],
        sit: [
            { x: 5, y: 6 },
            { x: 5, y: 8 },
    ...
    takadai: {
        ...
        scale: 2,
        size: { x: 9, y: 14 },
        originCoordinates: { x: 1740, y: -495 },
        spawnPoint: "down_left",
        backgroundImageUrl: "rooms/takadai/background.svg",
        backgroundColor: "#c0c0c0",
        needsFixedCamera: false,
        objects: [
            { x: 9, y: 0, url: "fences_and_thicket.svg", scale: 1, offset: { x: 176, y: 849 } },
            
            { x: 1, y: 1, url: "house.svg", scale: 1, offset: { x: 923, y: 911 } },
            { x: 0, y: 5, url: "house_under.svg", scale: 1, offset: { x: 927, y: 939 } },
            { x: 2, y: 6, url: "hanging_thing.svg", scale: 1, offset: { x: 1178, y: 978 } },
            { x: 1, y: 6, url: "seat.svg", scale: 1, offset: { x: 1150, y: 1035 } },
            { x: 0, y: 6, url: "seat.svg", scale: 1, offset: { x: 1110, y: 1015 } },
            { x: 2, y: 1, url: "a_frame_sign.svg", scale: 1, offset: { x: 1007, y: 1103 } },
            { x: 1, y: 7, url: "radio.svg", scale: 1, offset: { x: 1205, y: 936 } },
            { x: 0, y: 10, url: "telescope.svg", scale: 1, offset: { x: 1272, y: 887 } },
            { x: 0, y: 12, url: "telescope.svg", scale: 1, offset: { x: 1352, y: 847 } },
            { x: 5, y: 5, url: "fire.svg", scale: 1, offset: { x: 1290, y: 1076 } },
            { x: 8, y: 0, url: "denwa_box.svg", scale: 1, offset: { x: 1178, y: 1124 } },
            { x: 8, y: 2, url: "jizou_mini.svg", scale: 1, offset: { x: 1285, y: 1218 } },
            { x: 8, y: 3, url: "jizou.svg", scale: 1, offset: { x: 1317, y: 1171 } },
            { x: 8, y: 4, url: "jizou.svg", scale: 1, offset: { x: 1357, y: 1151 } },
            { x: 8, y: 5, url: "jizou.svg", scale: 1, offset: { x: 1397, y: 1131 } },
            
            { x: 9, y: 7, url: "wall_front_with_bush.svg", scale: 1, offset: { x: 1509, y: 1098 } },
            { x: 8, y: 7, url: "wall_front_with_bush_and_hole.svg", scale: 1, offset: { x: 1469, y: 1078 } },
            { x: 7, y: 7, url: "wall_front_with_bush.svg", scale: 1, offset: { x: 1429, y: 1058 } },
            { x: 6, y: 7, url: "wall_front_with_bush_lamp.svg", scale: 1, offset: { x: 1388, y: 1029 } },

            { x: 6, y: 6, url: "bush_cover.svg", scale: 1, offset: { x: 1388, y: 1082 } },
            { x: 7, y: 6, url: "bush_cover.svg", scale: 1, offset: { x: 1429, y: 1102 } },
            { x: 8, y: 6, url: "bush_cover.svg", scale: 1, offset: { x: 1469, y: 1122 } },
            
            { x: 6, y: 8, url: "wall_back_with_bush_and_sign.svg", scale: 1, offset: { x: 1385, y: 1010 } },
            { x: 6, y: 9, url: "wall_back.svg", scale: 1, offset: { x: 1452, y: 990 } },
            { x: 6, y: 10, url: "wall_back_with_hole.svg", scale: 1, offset: { x: 1492, y: 970 } },
            { x: 6, y: 11, url: "wall_back.svg", scale: 1, offset: { x: 1532, y: 950 } },
            { x: 4, y: 11, url: "wall_front.svg", scale: 1, offset: { x: 1504, y: 918 } },
            
            { x: 7, y: 12, url: "tree.svg", scale: 1, offset: { x: 1549, y: 863 } },
            { x: 8, y: 13, url: "mp_sign.svg", scale: 1, offset: { x: 1719, y: 979 } },
            { x: 9, y: 9, url: "tub_front.svg", scale: 1, offset: { x: 1524, y: 1006 } },
            { x: 7, y: 10, url: "tub_back.svg", scale: 1, offset: { x: 1526, y: 1040 } },
            { x: 8, y: 9, url: "water_surface.svg", scale: 1, offset: { x: 1569, y: 1053 } },
        ],
        sit: [
            { x: 2, y: 5 },
            { x: 2, y: 6 },
