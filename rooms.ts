...
export const rooms: { [roomId: string]: Room } = {
    ...
    bar_giko_square: {
        ...
        forbiddenMovements: [],
        doors: {
            up: { x: 11, y: 21, direction: "down", target: "NOT_READY_YET" },
            bar_giko: { x: 17, y: 17, direction: "down", target: "NOT_READY_YET" },
            yoshinoya: { x: 4, y: 15, direction: "right", target: "NOT_READY_YET" },
        },
        streamSlotCount: 0,
        secret: false
    },
