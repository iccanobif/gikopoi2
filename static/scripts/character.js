...
export const characters = {
    ...
    giko_hat: new Character("giko_hat", "svg", false),//!annualEvents.christmasPeriod.isNow()),
    shii_hat: new Character("shii_hat", "svg", false),//!annualEvents.christmasPeriod.isNow()),
