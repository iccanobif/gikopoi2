...
const characterObjects: CharacterObject[] = [
    ...
    { name: "chindonnya_shobon", portrait: { left: -0.5, top: -0.2 }, isHidden: false }, // all characters are visibile on new year's
    { name: "banana_naito", portrait: { left: -0.48, top: 0.13 } },
]
